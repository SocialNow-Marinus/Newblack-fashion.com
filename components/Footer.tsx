...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white text-black pt-32 pb-12 border-t border-black/10">
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-16 mb-24">
          <div className="lg:col-span-2 space-y-8">
            <Logo variant="black" className="h-8 md:h-10" />
            <p className="text-lg text-black/50 leading-relaxed max-w-sm serif italic">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4 text-sm font-bold uppercase tracking-widest text-black/60">
        ...
        <div className="pt-12 border-t border-black/5 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex space-x-12 text-[10px] uppercase tracking-[0.3em] font-bold">
            <Link to="/contact" className="hover:text-black transition-colors">Impressum</Link>
            <Link to="/privacy" className="hover:text-black transition-colors">Datenschutz</Link>
          </div>
        </div>
      </div>
    </footer>
